 ...
 *  \brief      Ensemble de fonctions de base pour le module repair
 *  \ingroup    repair
 */
...
*/
	...
	{
		$head[$h][0] = DOL_URL_ROOT.'/repair/apercu.php?id='.$object->id;
	...
	{
		$head[$h][0] = DOL_URL_ROOT.'/repair/contact.php?id='.$object->id;
	...
	{
		$head[$h][0] = DOL_URL_ROOT.'/repair/note.php?id='.$object->id;
		$head[$h][1] = $langs->trans('Notes');
		$head[$h][2] = 'note';
		$h++;
	}

	$head[$h][0] = DOL_URL_ROOT.'/repair/info.php?id='.$object->id;
