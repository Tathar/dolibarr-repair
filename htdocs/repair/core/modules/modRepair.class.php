...
//		$this->requiredby = array("modExpedition");
		...
		$this->tabs = array('thirdparty:+repair:Repair:@repair:$user->rights->repair->lire:/repair/thirdparty.php?id=__ID__');
		...
		$r++;
		$this->rights[$r][0] = 12503;
		$this->rights[$r][1] = 'Créer les devis de réparations';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'CreateEstimate';
...
/*
		$r++;
		$this->rights[$r][0] = 12582;
		$this->rights[$r][1] = 'Creer/modifier les réparations clients';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'creer';

		$r++;
		$this->rights[$r][0] = 12584;
		$this->rights[$r][1] = 'Valider les réparations clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'valider';

		$r++;
		$this->rights[$r][0] = 12586;
		$this->rights[$r][1] = 'Envoyer les réparations clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'repair_advance';
        $this->rights[$r][5] = 'send';
		...
		$r++;
		$this->rights[$r][0] = 12587;
		$this->rights[$r][1] = 'Cloturer les réparations clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'cloturer';

		$r++;
		$this->rights[$r][0] = 12588;
		$this->rights[$r][1] = 'Annuler les réparations clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'annuler';

		$r++;
		$this->rights[$r][0] = 12589;
		$this->rights[$r][1] = 'Supprimer les réparations clients';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'supprimer';

		$r++;
		$this->rights[$r][0] = 12521;
		$this->rights[$r][1] = 'Exporter les réparations clients et attributs';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'repair';
		$this->rights[$r][5] = 'export';
...
//
        ...
        $this->dictionnaries=array(
            ...
            'tabname'=>array(MAIN_DB_PREFIX."c_repair_support", MAIN_DB_PREFIX."c_machine_type"),			// List of tables we want to see into dictonnary editor
            'tablib'=>array("Repair Support", "Machine Type"),							// Label of tables
            'tabsql'=>array('SELECT f.rowid as rowid, f.code, f.label, f.active FROM '.MAIN_DB_PREFIX.'c_repair_support as f', 'SELECT f.rowid as rowid, f.code, f.label, f.active FROM '.MAIN_DB_PREFIX.'c_machine_type as f'),			// Request to select fields
            ...
            'tabcond'=>array($conf->repair->enabled, $conf->repair->enabled)			// Condition to show each dictionnary
        );
