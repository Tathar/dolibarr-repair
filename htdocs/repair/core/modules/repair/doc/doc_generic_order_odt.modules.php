...
/**
 *	\file       htdocs/repair/core/modules/repair/doc_generic_order_odt.modules.php
 *	\ingroup    societe
 ...
 */
class doc_generic_order_odt extends ModeleRepair
{
	...
	function __construct($db)
	{
		...
		$this->scandir = 'REPAIR_ADDON_PDF_ODT_PATH';	// Name of constant that is used to save list of directories to scan
		...
		$this->option_tva = 0;                     // Gere option tva REPAIR_TVAOPTION
	...
	function info($langs)
	{
		...
		$texte.= '<input type="hidden" name="param1" value="REPAIR_ADDON_PDF_ODT_PATH">';
		$texte.= '<table class="nobordernopadding" width="100%">';

		// List of directories area
		$texte.= '<tr><td>';
		$texttitle=$langs->trans("ListOfDirectories");
		$listofdir=explode(',',preg_replace('/[\r\n]+/',',',trim($conf->global->REPAIR_ADDON_PDF_ODT_PATH)));
		$listoffiles=array();
		...
		$texte.=$conf->global->REPAIR_ADDON_PDF_ODT_PATH;
		$texte.= '</textarea>';
        $texte.= '</td>';
	 ...
	 *
	 *	@param	Repair	$object					Object source to build document
	...
	function write_file($object,$outputlangs,$srctemplatepath)
	{
		...
		if ($conf->repair->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				dol_mkdir($conf->repair->dir_temp);
				...
				// Line of free text
				$newfreetext='';
				$paramfreetext='REPAIR_FREE_TEXT';
				...
				$odfHandler = new odf(
				    $srctemplatepath,
				    array(
						'PATH_TO_TMP'	  => $conf->repair->dir_temp,
