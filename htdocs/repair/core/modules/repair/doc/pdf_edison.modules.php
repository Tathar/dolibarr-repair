...
/**
 *	\file       htdocs/repair/core/modules/repair/pdf_edison.modules.php
 *	\ingroup    repair
 *	\brief      Fichier de la classe permettant de generer les repairs au modele Edison
 */
...
/**
 *	Classe permettant de generer les repairs au modele Edison
 */
class pdf_edison extends ModeleRepair
{
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0,$hookmanager=false)
	{
		...
		{
			$this->error=$langs->transnoentities("ErrorConstantNotDefined","REPAIR_OUTPUTDIR");
			return 0;
		}
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs ,$hookmanager)
	{
		...
		if($object->statut==0 && (! empty($conf->global->REPAIR_DRAFT_WATERMARK)) )
		{
            pdf_watermark($pdf,$outputlangs,$this->page_hauteur,$this->page_largeur,'mm',$conf->global->REPAIR_DRAFT_WATERMARK);
		}
    ...
    {
		return pdf_pagefoot($pdf,$outputlangs,'REPAIR_FREE_TEXT',$this->emetteur,$this->marge_basse,$this->marge_gauche,$this->page_hauteur,$object);
    }
}
